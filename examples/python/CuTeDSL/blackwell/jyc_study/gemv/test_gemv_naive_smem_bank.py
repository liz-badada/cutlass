...
class Sm100DenseGemvKernelNaiveSmemBank:
    def __init__(self):
    ...
    def kernel(
        ...
        sB_layout = cute.make_layout((mma_tiler_mnk[2] + 32,), stride=(1,)) # 32 is the padding
        # sB_layout_padded = cute.make_layout((mma_tiler_mnk[2],), stride=(2,))
        # sB_layout_padded = cute.make_layout((mma_tiler_mnk[2],), stride=(4,))  # stride=4
        sB = smem.allocate_tensor(b_dtype, sB_layout, 16)
...
def run_gemv_naive_smem_bank(
    ...
    """
    print("=" * 60)
    print("Launching Blackwell Float32 GEMV Naive + SMEM + Bank Padding Test")
    print("-" * 60)
    ...
    gemv = Sm100DenseGemvKernelNaiveSmemBank()
    # Initialize Stream
